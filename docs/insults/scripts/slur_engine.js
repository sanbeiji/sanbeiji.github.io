function Insult() {
	...
	return "Thou " + 
		   getRandomItem(insult1) + ", " + 
		   getRandomItem(insult2) + " " +
		   getRandomItem(insult3) + "!";
}

document.addEventListener('DOMContentLoaded', function() {
	const insultButton = document.getElementById("insult_me");
	const resultDiv = document.getElementById("result");

	if (insultButton && resultDiv) {
		insultButton.addEventListener('click', function () {
			resultDiv.innerHTML = Insult();
