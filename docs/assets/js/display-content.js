function setHTML(id, html) {
  if (window.SanbeijiDocs) {
    window.SanbeijiDocs.setHTML(id, html);
  } else {
...
var monthNames = window.SanbeijiDocs ? window.SanbeijiDocs.monthNames : ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
var today = new Date();
